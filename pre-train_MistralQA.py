...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default="Pre-Train Run_1 MedLFQA", help='Describes the conducted experiment')
    parser.add_argument('--run', type=int, default=1, help='run number for wandb logging')

    # I/O paths for models, CT, queries and qrels
    parser.add_argument('--save_dir', type=str, default="models/pre-train_run-1_MedLFQA/", help='path to model save dir')
